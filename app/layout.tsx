...
export const metadata: Metadata = {
  ...
  /* Classic favicon set generated by realfavicongenerator. Files live
   * at the public-root paths so /favicon.ico, /apple-touch-icon.png,
   * etc. resolve without an /assets/ prefix — what browsers, crawlers,
   * and bookmark widgets all probe by default. The android-chrome PNGs
   * are referenced from app/manifest.ts so PWA installs pick them up. */
  icons: {
    icon: [
