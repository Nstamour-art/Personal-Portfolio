...
export const EDITORIAL: EditorialCopy = {
  home: {
    ...
    reelBlurb:
      'A motion artist and AI workflow engineer. Selected work across broadcast, independent film and product. Currently building tools that help frames ship faster.',
  ...
  footer: {
    ...
    colophon: ['Helvetica Neue', 'IBM Plex Mono', 'Hand-built, no CMS', "v.26.05"],
